...
def eliminar_empleado():
    ...
    empleados_con_id = [emp for emp in empleados if emp['ID del empleado'].strip() == id_empleado]
    ...
    empleados = [emp for emp in empleados if emp['ID del empleado'].strip() != id_empleado]
...
def buscar_empleado():
    ...
    coincidencia = next((emp for emp in empleados if emp['ID del empleado'].strip() == id_empleado), None)
